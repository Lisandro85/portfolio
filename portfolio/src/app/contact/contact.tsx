...
export default function Contact() {
  return (
    <div className="mx-5 bg-[rgba(0,109,119,0.8)] rounded-lg shadow-md mt-10 py-10 px-4 mb-96">
      {/* Título */}
      <h1 className="text-6xl sm:text-7xl md:text-8xl font-bold text-[#06d6a0] font-Amatic-SC text-center">
        Contact Me
      </h1>

      {/* Descripción */}
      <p className="text-2xl sm:text-3xl md:text-4xl mt-4 text-[#06d6a0] font-bold font-Amatic-SC text-center leading-relaxed">
