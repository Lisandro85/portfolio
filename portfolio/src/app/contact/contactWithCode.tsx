...
export default function contactWithCode() {
  return (
    <div className="flex items-center justify-center w-full h-screen px-4 sm:px-6 lg:px-10 mt-10">
      <div className="w-full max-w-xl bg-[rgba(0,0,0,0.8)] p-5 rounded-lg shadow-xl">
        <p>
        ...
        <p className="text-gray-400 ml-10 sm:ml-12 md:ml-14 lg:ml-16">{"<>"}</p>
        <ContactMethod
          icon={<Linkedin />}
          text="Linkedin"
        ...
        />
        <p className="text-gray-400 ml-12 sm:ml-14 md:ml-16 lg:ml-20">{"/>"}</p>
        <p className="text-gray-400 ml-10 sm:ml-12 md:ml-14 lg:ml-16">
          {"</>"}
        </p>
        <p className="text-violet-500 ml-8 sm:ml-10 md:ml-12 lg:ml-14">{")"}</p>
